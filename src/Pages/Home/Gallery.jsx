...
const Gallery = ({ images }) => {
  ...
  return (
    ...
    >
      <h2 className="text-3xl font-bold text-black mb-4">Gallery</h2>
      <p className="text-gray-400 mb-10">
        Explore highlights from our gaming community — tournaments, live events,
        and top plays. <br /> Every snapshot captures excitement, teamwork, and epic moments.
      </p>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4 px-4 max-w-6xl mx-auto">
        ...
        <motion.div
          ...
          className="md:col-span-1 overflow-hidden rounded-xl"
        ...
        <div className="flex flex-col gap-4">
          ...
          <motion.img
            ...
            className="rounded-xl w-full flex-1 object-cover transition-transform duration-300"
            variants={imageVariants}
            whileHover={{ scale: 1.05 }}
          />
        </div>
